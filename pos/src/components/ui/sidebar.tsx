...
const SIDEBAR_WIDTH_MOBILE = "9.5rem";
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="default"
      className={cn(
        "md:size-10 size-8 shadow-md border-2 border-white",
        className
      )}
      onClick={(event) => {
        onClick?.(event);
    ...
    >
      ...
      <ChevronsLeft
        className={`${
          !open && "rotate-180"
        } transition-all duration-500 size-[20px]`}
      />
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden border-0",
        className
      )}
      {...props}
    />
