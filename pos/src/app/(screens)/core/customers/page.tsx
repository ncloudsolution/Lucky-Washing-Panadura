  ...
  return (
    <div className="flex relative w-full">
      <div className="flex flex-col h-full w-full">
        <div className="flex justify-between items-center w-full mb-5 pb-2 border-b-2">
          <div className=" bg-slate-200 rounded-md px-3 py-2 flex items-center w-fit">
            <Input
              autoComplete="off"
              type="text"
              className="bg-transparent border-none shadow-none focus:border-none focus:shadow-none w-[450px]"
